...
#assign the path and file name of CND-1 expression phenotype
output = r'C:\\Users\\dell\\Desktop\\CND-1_expression_phenotype.txt'
##################################################################################################################################################
CTR_exp=np.sum(CTR_exp_matrix,axis=1)/len(CTR_exp_matrix.columns)
CTR_exp_cell_list=list(CTR_exp[CTR_exp>=0.99].index) ###stable expression cutoff >=0.99
CTR_noexp_cell_list=list(CTR_exp[CTR_exp<=0.01].index) ###stable no expression cutoff <=0.01
