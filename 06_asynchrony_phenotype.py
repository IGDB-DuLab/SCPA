...
### input the division time file of control embryos 
...
### input the division time file of RNAi embryos
...
### input the folder path for storing files about division asynchrony phenotype
...
for stage in [Stage_AB2,Stage_AB4,Stage_AB8,Stage_AB16,Stage_AB32,Stage_AB64,Stage_AB128]:
    ...
    for cell in cell_list:
        ...
        cell_rmsd=scipy.spatial.distance.pdist(cell_vector_matrix)/len(cell_vector_matrix.columns)**0.5#to calculate rmsd       
