...
control = pd.read_csv(r"C:\Users\dell\Desktop\output_folder\Cell_cycle_length_matrix_ctr.txt", sep="\t", index_col=0)                

### input the path and name of corresponding RNAi file of cell cycle length or division timing or division angle (A-P)
experiment = pd.read_csv(r"C:\Users\dell\Desktop\output_folder\Cell_cycle_length_matrix_RNAi.txt", sep="\t", index_col=0)                

###assign the phenotype name and output folder path 
...
z_score.to_csv(os.path.join(phenotype_output_folder_path,Phenotype_name+"_Z-score.txt"), sep="\t") #out
...
q_value_bh.columns = z_score.columns
q_value_bh.index = z_score.index
q_value_bh.to_csv(os.path.join(phenotype_output_folder_path,Phenotype_name+"_Q-value_binary_0.01.txt"), sep="\t")                 #out
