...
### input raw data folder of control or RNAi or RNAi_add
File_Directory = r'C:\Users\dell\Desktop\raw_data'   

### input the corresponding CND-1 binary expression matrix of control or RNAi or RNAi_add from script "02_expression.py"
...
Output_Folder = r'C:\Users\dell\Desktop\output_folder'   

### assign expression onset file name
output_file_name='CND-1_expression_onset_matrix' 
...
for terminal_cell_name in Expressed_terminal_cells:
    ...
    ################################################################################################                                            
            ...
            emb_output_2=emb_output_.loc[track_temp]#cell list of tracks
