...
### input the path and file of division timing data of control embryos
control_embryos = pd.read_csv(r"C:\Users\dell\Desktop\output_folder\Division_timing_matrix_ctr.txt", sep="\t", index_col=0)

### input the path and file of division timing data of RNAi embryos
RNAi_embryos = pd.read_csv(r"C:\Users\dell\Desktop\output_folder\Division_timingh_matrix_ctr.txt", sep="\t", index_col=0)

Output_Folder = r'C:\Users\dell\Desktop\output_folder'   # assign the output folder path

output_division_asymmetry_file_name_CTR='Division_asymmtry_matrix_CTR' # input control file name

output_division_asymmetry_file_name_RNAi='Division_asymmtry_matrix_RNAi' # input RNAi file name

output_division_asymmetry_Phenotype_file_name_RNAi='RNAi_division_asymmetry_phenotype_matrix' # input the file name of division asymmetry phenotype
...
RNAi_slope_embryos=list(RNAi_slope[RNAi_slope['q-value binary']==0].index)
...
ADS_matrix=ADS_matrix*1.25       
ADS_matrix=ADS_matrix[RNAi_slope_embryos]
...
z_score.to_csv(os.path.join(Output_Folder,output_division_asymmetry_Phenotype_file_name_RNAi+'_Z-Score.txt'), sep="\t") 
...
q_value_bh.to_csv(os.path.join(Output_Folder,output_division_asymmetry_Phenotype_file_name_RNAi+'_Q-Value.txt'), sep="\t") 
...
q_value_bh.columns = z_score.columns
q_value_bh.index = z_score.index
q_value_bh.to_csv(os.path.join(Output_Folder,output_division_asymmetry_Phenotype_file_name_RNAi+'_Q-Value_binary_0.01.txt'), sep="\t")
