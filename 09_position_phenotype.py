...
### input the folder path of CTR spatial distance matrix
CTR_distance_matrix_path = os.path.abspath(r'C:\Users\dell\Desktop\output_folder\CTR_distance_matrix')

### input the folder path of RNAi spatial distance matrix
RNAi_distance_matrix_path = os.path.abspath(r'C:\Users\dell\Desktop\output_folder\RNAi_distance_matrix')

### input the folder path for storing relative cell position phenotype
...
WT_single_cell_RMSD_all=WT_single_cell_RMSD_all[~WT_single_cell_RMSD_all.index.duplicated(keep='first')]     
