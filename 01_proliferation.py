...
import numpy as np
######################################################################input files
#output_path = os.path.abspath(r'C:\Users\dell\Desktop\output_folder')###Enter the output folder path
#if not os.path.exists(output_path):
    #os.makedirs(output_path)

File_Directory = r'E:\code and table\data\Raw_data_Control_test'   # input the folder name of raw data of control or RNAi or RNAi_add

Output_Folder=os.path.abspath(r'C:\Users\Desktop\output_folder')  # input output folder path
if not os.path.exists(Output_Folder):
    os.makedirs(Output_Folder)
    
output_cell_cycle_length_file_name='Cell_cycle_length_matrix_ctr' #input the name of cell cycle length file
output_cell_division_timing_file_name='Cell_division_timing_matrix_ctr' #input the name of cell division timing file
...
for each_emb in raw_data_list:
    ...
    cell_proliferation.index = np.arange(len(cell_proliferation))  
