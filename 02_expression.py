...
File_Directory = r'E:\code and table\data\Raw_data_Control_test'   

### assign the output folder path
Output_Folder = r'C:\Users\dell\Desktop\output_folder'   

### input the name of expression value file
output_gene_expression_value_file_name='CND-1_expression_value_matrix' 

### input expression cut off, for example "expression: >= 1500","no expression: < 1500"
expression_cut_off=1500 
